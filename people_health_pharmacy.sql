...
INSERT INTO `product` (`ProductID`, `ProductCategory`, `ProductName`, `Description`, `Quantity`, `Price`, `CategoryID`) VALUES
(4, 'Category A', 'pendol superfast', 'qwer', '999', '40.00', NULL),
(5, 'Category B', '1', 'rjrjr', 'testing', '2.00', NULL),
(6, 'Category C', 'pendol ', 'For fewer', '100', '40.00', NULL);
